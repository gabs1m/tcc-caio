<html>
  ...
  <body>
    <header>
      <nav class="nav-bar">
        ...
        <div class="login-button">
          <button>
            <a href="CrudUsuario/formsLogin.php"><img src="imagens/user_icon.png" /></a>
          </button>
        </div>

        <div class="mobile-menu-icon">
          <button onclick="menuShow()">
            <img class="icon" src="imagens/icon_menu.png" />
          </button>
        </div>
      </nav>
    ...
    <div class="corpo">
      <?php for($i = 0; $i < 10; $i++): ?>
      <div class="card">
        <img src="imagens/Nomes-para-cachorro_capa.png" />
        <div>
          <h1>Feira de Adoção</h1>
          <h2>Evento disponível: Feira de adoção, 12/06/2024 - 16 da tarde</h2>
